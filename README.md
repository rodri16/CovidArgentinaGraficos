...
![Ejemplo Grafico con la Tasa Diaria](/Graficos/Agosto/TasaDiariaLine_31Aug.png)
![Ejemplo Grafico con la Tasa Diaria sublplot](/Graficos/Agosto/Todos_diario_sub_31Aug.png)

Ej Totales
![Ejemplo Grafico del total](/Graficos/Agosto/Contagios_tot_31Aug.png)
![Ejemplo Grafico del total subplot](/Graficos/Agosto/Todos_tot_31Aug.png)

Ej totales en escala logaritmica
![Ejemplo Grafico del total logaritmico](/Graficos/Agosto/Contagios_totTests_log31Aug.png)

Ej total de tests diarios
![Ejemplo tests diarios](/Graficos/Agosto/TestDiarioBar_31Aug.png)

Ej relacion entre tests y positivos
![Ejemplo relacion tests y positivos](/Graficos/Agosto/Tasa_Cont_Test31Aug.png)
