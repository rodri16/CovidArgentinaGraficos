...
![Ejemplo Grafico con la Tasa Diaria sublplot](/Graficos/2021/Agosto/TasaDiaria_MA_18Aug.png)

-----------
Cantidad de gente vacunada primera y segunda dosis.
![Vacunados primera y segunda dosis](/Graficos/2021/Agosto/Vacunas_18Aug.png)

-----------
TOTALES: Contagios, Muertos, recuperados y pruebas diagnósticas (tests)
![Ejemplo Grafico del total](/Graficos/2021/Agosto/Contagios_tot_18Aug.png)

-----------
Total de pruebas diagnósticas (tests) diarias
![Ejemplo tests diarios](/Graficos/2021/Agosto/TestDiarioBar_18Aug.png)

-----------
Relación entre Tests y positivos, el porcentaje de testeados que es positivo.
![Ejemplo relacion tests y positivos](/Graficos/2021/Agosto/Tasa_Cont_Test18Aug.png)
