...
![Ejemplo Grafico con la Tasa Diaria sublplot](/Graficos/2021/Marzo/TasaDiaria_MA_07Mar.png)

-----------
Cantidad de gente vacunada primera y segunda dosis.
![Vacunados primera y segunda dosis](/Graficos/2021/Marzo/Vacunas_07Mar.png)

-----------
TOTALES Contagios, Muertos, recuperados y pruebas diagnósticas (tests)
![Ejemplo Grafico del total](/Graficos/2021/Marzo/Contagios_tot_07Mar.png)

-----------
Total de pruebas diagnósticas (tests) diarias
![Ejemplo tests diarios](/Graficos/2021/Marzo/TestDiarioBar_07Mar.png)

-----------
Relacion entre Tests y positivos, el porcentaje de testeados que es positivo.
![Ejemplo relacion tests y positivos](/Graficos/2021/Marzo/Tasa_Cont_Test07Mar.png)
